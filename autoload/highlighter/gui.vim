"==========================================================
" autoload/highlighter/gui.vim
"
" Author: Yasumasa TAMURA (tamura.yasumasa@gmail.com)
" Last Change: 15 Nov. 2017.
"==========================================================

function! highlighter#gui#rgb(r, g, b) abort
    return "#" . s:rgb2hex(a:r, a:g, a:b)
endfunction


function! highlighter#gui#xterm(id) abort
    if a:id == '' | return '' | endif
    if a:id < 0 || a:id > 255
        throw highlighter#helper#error("Invalid color ID in func hd256#gui#xterm")
    endif
    return call('highlighter#gui#rgb', s:gui_color_map[a:id])
endfunction
